...
class EditInfoPage extends StatefulWidget {
  ...
  const EditInfoPage({super.key, required this.place});
...
class _EditInfoPageState extends State<EditInfoPage> {
  ...
  late TextEditingController _phoneNumberTextController, _emailTextController, _instagramTextController,_facebookTextController,_starsTextController, _websiteTextController,
      _englishDescriptionTextController, _deutschDescriptionTextController;
  ...
  void initState() {
    ...
    _phoneNumberTextController = TextEditingController(text: widget.place.phoneNumbers.join(", "));
    _emailTextController = TextEditingController(text: widget.place.email);
    _instagramTextController = TextEditingController(text: widget.place.instagram);
    _facebookTextController = TextEditingController(text: widget.place.facebook);
    _starsTextController = TextEditingController(text: widget.place.stars.toString());
    _websiteTextController = TextEditingController(text: widget.place.website);
    _englishDescriptionTextController = TextEditingController(text: widget.place.description);
    _deutschDescriptionTextController = TextEditingController(text: widget.place.descriptionDe);
  ...
  saveInfo() async {
    try {
      final itemRef = Config.fireStore
          ...
          .doc(widget.place.id);
      widget.place.phoneNumbers = _phoneNumberTextController.text.split(",");
      widget.place.email = _emailTextController.text.trim();
      widget.place.instagram = _instagramTextController.text.trim();
      widget.place.facebook = _facebookTextController.text.trim();
      widget.place.stars = int.parse(_starsTextController.text.trim());
      widget.place.website = _websiteTextController.text.trim();
      widget.place.description = _englishDescriptionTextController.text.trim();
      widget.place.descriptionDe = _deutschDescriptionTextController.text.trim();
      itemRef.update(widget.place.toJson());
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(AppLocalizations.of(context)!.infoEditedSuccessfully)));
      Navigator.pop(context);
      setState(() {
        files.clear();
        ...
        _instagramTextController.clear();
        _facebookTextController.clear();
        _starsTextController.clear();
        _websiteTextController.clear();
        _englishDescriptionTextController.clear();
        _deutschDescriptionTextController.clear();
        uploading = false;
      });
    } catch (e) {
      if (kDebugMode) {
